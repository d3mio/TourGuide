      ...
      >
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          ...
          <div className="flex flex-col gap-3">
            <button className="w-full flex items-center justify-center gap-3 bg-surface2 hover:bg-bordercolor border border-bordercolor rounded-lg py-3 transition-colors text-sm font-medium text-textdim hover:text-textcolor">
